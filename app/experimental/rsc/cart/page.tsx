...
// ──────────────────────────────────────────────────────────────────
// STAGE B: SERVER COMPONENT CART WITH SUSPENSE STREAMING
// Same RSC architecture as Stage C but without any static caching.
// The cart is read from cookies on the server and product data is
// fetched in a single batched DB query — streamed via Suspense.
// ──────────────────────────────────────────────────────────────────
export default async function RSCCartPage() {
  return (
